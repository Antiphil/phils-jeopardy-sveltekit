	...
	<div class="popup" role="dialog" aria-modal="true">
		...
		{:else}
			...
			<div class="popup-header">
				<div class="popup-title">Anmelden</div>
				<div class="popup-sub">Wähle einen Anbieter</div>
			</div>
			...
			<p class="privacy-note">
				...
				<a href="/terms" onclick={onclose}>Nutzungsbedingungen</a>
				und
				<a href="/privacy" onclick={onclose}>Datenschutzerklärung</a>.
			</p>
		{/if}
